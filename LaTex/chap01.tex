...
Demand prediction is crucial for effective pricing strategies in accommodation services. Understanding future demand patterns allows providers to optimize pricing decisions and maximize revenue. Various methods can be employed for demand forecasting, ranging from traditional statistical techniques to advanced machine learning algorithms. In this section, we briefly outline some of the commonly used forecasting approaches and discuss their applicability.

Accurate demand prediction forms the core of the proposed pricing model. Its effectiveness depends primarily on the quality of the forecasts, making the choice of an appropriate method particularly important. While the selected method can have significant impact on the overall performance of the pricing strategy, the underlying structure of the model can accommodate any forecasting technique that produces suitable output.

\subsection{Statistical prediction}
Traditional statistical methods for demand forecasting include time series analysis, moving averages, and exponential smoothing \cite{Petricek2021}. These methods rely on historical data to identify patterns and trends that can be extrapolated into the future.




Time series models such as ARIMA (AutoRegressive Integrated Moving Average) are particularly popular for their ability to capture seasonality and trends in data. These models are relatively simple to implement and interpret, making them accessible for many accommodation providers. However, they may struggle to capture complex patterns in data, especially when multiple influencing factors are at play.

\subsection{Machine learning predictions}


\section{Price Setting}
% klasicka maximalizace revenue rovnice a nas pristup k nastaveni ceny
